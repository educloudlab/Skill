...
public partial class AjeerecordsView
{
    ...
    public string? ExamDistrict { get; set; }

    public string? ExamBranchCode { get; set; }

    public string? ExamAddress1 { get; set; }
    ...
    public string? EWalletTransactionType { get; set; }

    public string? EWalletTransactionMode { get; set; }

    public string? EWalletTransactionId { get; set; }

    public DateTime? EWalletTransactionDate { get; set; }

    public decimal? EWalletTransactionAmount { get; set; }
