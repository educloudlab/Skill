...
public partial class Nsdcjan23
{
    ...
    public double? StudentCourseFeeId { get; set; }
    ...
    public double? IsHokiosk { get; set; }
    ...
    public double? YearOfPassing { get; set; }
