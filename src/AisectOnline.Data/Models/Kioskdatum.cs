...
public partial class Kioskdatum
{
    ...
    public virtual DistrictMasterOld16052022? District { get; set; }
    ...
    public virtual ICollection<KioskdataService> KioskdataServices { get; set; } = new List<KioskdataService>();
