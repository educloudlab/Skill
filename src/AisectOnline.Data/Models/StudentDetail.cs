...
namespace AisectOnline.Data.Models
{
    public class StudentDetail
    {
        ...
        public IList<StudentDetail> Liststudent { get; set; }
        public List<CourseName> listcoursename { get; set; } = new List<CourseName>();

        public List<SubjectName> listSubjectName { get; set; } = new List<SubjectName>();


        public List<Services> listservice { get; set; } = new List<Services>();
